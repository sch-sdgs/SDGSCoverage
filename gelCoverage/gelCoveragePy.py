...
class Coverage:
    ...
    def make_exons_bed(self):
        ...
        for i in tqdm.tqdm(xrange(0,numTotalResults,5000)):
            url="http://bioinfo.hpc.cam.ac.uk/cellbase/webservices/rest/latest/hsapiens/feature/gene/all?include=name,chromosome,transcripts.exons.start,transcripts.exons.exonNumber,transcripts.id,transcripts.strand,transcripts.exons.end,transcripts.exons.sequence,transcripts.exons.cdsStart,transcripts.exons.cdsEnd,exonNumber&limit=100&skip="+str(i)
